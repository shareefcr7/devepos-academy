    ...
    <footer className="relative bg-navy pt-32 pb-10 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 w-full overflow-hidden leading-none rotate-180">
        <svg
          ...
          className="relative block w-[calc(100%+1.3px)] h-[100px] fill-[#0A192F]"
        >
          <path
      ...
      <div className="container mx-auto px-6 relative z-10">
          ...
          <div>
             ...
             <div className="flex space-x-4">
                {[Github, Twitter, Linkedin, Youtube].map((Icon, i) => (
                  <Link key={i} href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-electric-blue/20 hover:text-electric-blue transition-all">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center bg-navy">
           <p className="text-gray-500 text-sm bg-navy">© 2024 DEVOPS HUB Academy. All rights reserved.</p>
           <div className="flex space-x-6 mt-4 md:mt-0 bg-navy">
